...
printf "
\e[1mUso\e[0m
         	./Ejercicio5.sh [archivoA] [archivoB] [L|P] [string]
 
\e[1mParametros\e[0m          
		2 archivos a comparar (cantidad de líneas, palabras, espacios y la palabra con mayor ocurrencia), 
		[Opcional] -L para indicar la cantidad de líneas iguales entre los dos archivos,
		[Opcional] -P seguido de una o varias palabras, para indicar cual/es de esas palabras se repiten en ambos archivos.
\e[1mDescripción\e[0m
                Lee dos archivos de texto (En formato .txt) y los compara indicando: cantidad de líneas, palabras, espacios y la palabra con mayor ocurrencia, de cada archivo. Si se indica el parámetro -L, se mostrará la cantidad de líneas iguales entre ambos archivos. Si se indica el parámetro -P seguido de una o más palabras, se mostrará cuáles palabras de ese conjunto aparecen en ambos archivos.
               
\e[1mEjemplo\e[0m
       
      bash ./Ejercicio5.sh archivo1.txt archivo2.txt -L -P sistemas operativos
"
